              ...
              <div className="flex flex-col gap-stack-sm pt-stack-sm">
                {channels.map((channel) => (
                  <a
                    ...
                    className="glass glass-sm glass-hover flex min-w-0 items-center gap-stack p-[18px] transition-transform duration-300 ease-out hover:-translate-y-1"
                  >
                    <IconTile name={channel.icon} size="sm" />
